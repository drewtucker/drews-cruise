...
class DestinationPage extends React.Component {
  render() {
    ...
    const {
      ...
      activity1 = 'Canoe or kayak down pristine unblemished glacial rivers',
      activity2 = 'Experience lush pine forests and forgotten treasures',
      activity3 = 'Lorem Ipsum epsum along icy glaciers in the freezing pacific ocean',
      activity4 = 'Enojy prime fishing and crabbing opportunities',
      view,
    } = this.props;
